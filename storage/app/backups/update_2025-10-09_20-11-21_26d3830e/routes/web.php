...
// Progress endpoint for URL training (no session/auth) - placed outside admin group to avoid locks
Route::get('/admin/ai-training/import-progress', [\App\Http\Controllers\Admin\AiTrainingController::class, 'importProgress'])
...
Route::post('/admin/ai-training/import-stop', [\App\Http\Controllers\Admin\AiTrainingController::class, 'importStop'])
    ->withoutMiddleware([\Illuminate\Session\Middleware\StartSession::class, \App\Http\Middleware\Authenticate::class, \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class])
    ->name('ai-training.import-stop');
